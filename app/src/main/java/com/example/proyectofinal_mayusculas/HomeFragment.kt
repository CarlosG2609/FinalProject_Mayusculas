...
class HomeFragment : Fragment() {
    ...
    private fun loadAppliedRules(){
        var cont = 1
        viewModel.setAppliedRules("2", cont++)
        viewModel.setAppliedRules("1,2", cont++)
        viewModel.setAppliedRules("9b,2", cont++)
        viewModel.setAppliedRules("2,5", cont++)
        viewModel.setAppliedRules("1", cont++)
        viewModel.setAppliedRules("1,2", cont++)
        viewModel.setAppliedRules("8", cont++)
        viewModel.setAppliedRules("1,2,1b", cont++)
        viewModel.setAppliedRules("1,2,7", cont++)
        viewModel.setAppliedRules("1,2,7", cont++)
        viewModel.setAppliedRules("1,2,10", cont++)
        viewModel.setAppliedRules("2", cont++)
        viewModel.setAppliedRules("1,2", cont++)
        viewModel.setAppliedRules("2,3b", cont++)
        viewModel.setAppliedRules("2,1,12", cont++)
        viewModel.setAppliedRules("2,1,12", cont++)
        viewModel.setAppliedRules("5b", cont++)
        viewModel.setAppliedRules("6b", cont++)
        viewModel.setAppliedRules("5b", cont++)
        viewModel.setAppliedRules("2,9b", cont++)
        viewModel.setAppliedRules("2,9", cont++)
        viewModel.setAppliedRules("1,2,3", cont++)
        viewModel.setAppliedRules("2,14", cont++)
        viewModel.setAppliedRules("1", cont++)
        viewModel.setAppliedRules("2,13", cont++)
        viewModel.setAppliedRules("1,2", cont++)
        viewModel.setAppliedRules("1,2", cont++)
        viewModel.setAppliedRules("1,2,10b", cont++)
        viewModel.setAppliedRules("1,2,10b", cont++)
        viewModel.setAppliedRules("2,11b", cont++)
        viewModel.setAppliedRules("1,2,11b", cont++)
        viewModel.setAppliedRules("1,2,15", cont++)
        viewModel.setAppliedRules("1,2,15", cont++)
        viewModel.setAppliedRules("1,3,12b", cont++)
        viewModel.setAppliedRules("1,2,10", cont++)
        viewModel.setAppliedRules("1,2,10", cont++)
        viewModel.setAppliedRules("1,10b", cont++)
        viewModel.setAppliedRules("1,2,14b", cont++)
    }
